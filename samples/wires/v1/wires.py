...
class WireDataset(utils.Dataset):

    def load_wire(self, dataset_dir, subset):
        """Load a subset of the wire dataset.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val
        """
        # Add classes. We have only one class to add.
        self.add_class("wire", 1, "wire")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a wire dataset image, delegate to parent class.
        image_info = self.image_info[image_id]
        if image_info["source"] != "wire":
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = WireDataset()
    dataset_train.load_wire(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = WireDataset()
    dataset_val.load_wire(args.dataset, "val")
    dataset_val.prepare()
    ...
    model.train(dataset_train, dataset_val,
                ...
                epochs=30,
                layers='heads',
		augmentation=imgaug.augmenters.Sometimes(2/3, imgaug.augmenters.OneOf(
                                            [
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect wires.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/wire/dataset/",
                        help='Directory of the wire dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(WireConfig):
